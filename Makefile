...
INCLUDES  := -I/$/usr/opt/cuda/7.0/samples/common/inc/
LIBRARIES :=
...
HEADER = init_cuda.h struct.h cuda_scft.h  init.h  cuda_aid.cuh spline.h
FLAGFFT=-lcufft 
################################################################################
...
scan: main.o scan.o  init.o  cuda_aid.o cuda_scft.o spline.o
...
clean:
	rm -f scan main.o scan.o 
	rm -rf ../../bin/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)/scan
